            ...
            <div className="container">
                <div className="row g-5 align-items-center">
                    <div className="col-12 col-lg-6">
                        {/*-- Features Image --*/}
                        <div className="features-img style-three">
                            <Image className="img-anim-left tilt-image h-auto" data-delay="0.5" src={bgImg44}
                                 alt=""/>
                            <Image className="float-img scroll-image" src={bgImg38} alt=""/>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-lg-6">
                        ...
                        <div className="ps-xl-5">
                            <div className="d-flex flex-wrap flex-lg-nowrap align-items-center gap-4 gap-xxl-5 mb-5">
                                {/*-- About Countdown --*/}
                                <AboutCountdown/>
