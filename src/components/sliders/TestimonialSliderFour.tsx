...
interface TestimonialSliderFourProps {
    testimonials: TestimonialData[];
}

/** Reusable SVG quote icon — identical for every slide */
function QuoteIcon() {
    return (
...
export default function TestimonialSliderFour({ testimonials }: TestimonialSliderFourProps) {
    if (!testimonials.length) return null;

    return (
        <div className="col-12 col-md-6 col-lg-7 col-xl-8">
            <div className="swiper testimonial-swiper-four fadeInUp" data-delay="0.8" id="testimonialSwiperFour">
                <Swiper
                ...
                >
                    {testimonials.map((t) => (
                        <SwiperSlide key={t._id} className="swiper-slide">
                            <div className="testimonial-card-four">
                                ...
                                <div className="testimonial-info">
                                    ...
                                    <div className="testimonial-img d-flex align-items-center gap-3 gap-xxl-4">
                                        ...
                                        <div>
                                            <h5>{t.name}</h5>
                                            <p className="mb-0">{t.role ?? t.organization ?? ""}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
